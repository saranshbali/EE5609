...
to the form
\begin{align}
	\vec{x}^T\myvec{ 0 & 1/2 \\ 1/2 & 0}\vec{x} = c
\end{align}
...
\begin{align}
	\vec{x}^T\myvec{\frac{1-\sqrt{2}}{4-2\sqrt{2}} & \frac{1+\sqrt{2}}{4+2\sqrt{2}} \\ \frac{1}{4-2\sqrt{2}} & \frac{1}{4+2\sqrt{2}}} \myvec{\sqrt{2} &0 \\ 0 & -\sqrt{2}} \myvec{\frac{1-\sqrt{2}}{4-2\sqrt{2}} & \frac{1}{4-2\sqrt{2}}  \\ \frac{1+\sqrt{2}}{4+2\sqrt{2}} & \frac{1}{4+2\sqrt{2}}}\vec{x} = 1
\end{align} 
\end{document}