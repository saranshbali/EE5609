...
%
\section{Problem}
ABCD is a quadrilateral in which AD = BC and $\angle{DAB}  = \angle{CAB}$ . Prove that
\begin{align}
...
\begin{align}
 & AD=BC \qquad & [Given] \\
 & \angle DAB =  \angle CBA \qquad & [Given] \\
 & AB=BA  \qquad & [Common \enspace Side]
\end{align}
Hence, by SAS Congruence rule, $\triangle ABD \cong \triangle BAC$ proving (a).

Now, since $\triangle ABD \cong \triangle BAC$, thus by CPCT (Corresponding Parts of Congruent Triangle)
\begin{align}
	& \quad BD = AC \\
	& \quad \angle ABD = \angle BAC
\end{align}
proving (b) and (c).
\end{document}