...
Given two vectors 
\begin{align}
\alpha_1 = \myvec{1 \\ 0 \\ -1 \\ 2} \quad and \quad \alpha_2 = \myvec{2 \\ 3 \\ 1 \\ 1}
\end{align}
...
\begin{align}
& \vec{f(\alpha_1)} = \alpha_1^T\vec{c} = \myvec{1 & 0 & -1 & 2}\myvec{c_1 \\ c_2 \\ c_3 \\ c_4} = 0 \\
& \vec{f(\alpha_2)} = \alpha_2^T\vec{c} = \myvec{2 & 3 & 1 & 1}\myvec{c_1 \\ c_2 \\ c_3 \\ c_4} =  0
\end{align}
or equivalently
\begin{align}
